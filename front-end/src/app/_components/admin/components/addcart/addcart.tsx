...
export const AdminAddCart = () => {
  ...
  return (
    <React.Fragment>
      ...
      >
        <div className="flex flex-col justify-between items-center w-[500px] h-[700px]">
          <div className="flex justify-evenly items-center w-full h-[60px] border bg-[#E0E0E0] px-4">
            <div>.</div>
          ...
          <div className="flex justify-end items-center w-full h-[10%] py-6 bg-[#E0E0E0]">
